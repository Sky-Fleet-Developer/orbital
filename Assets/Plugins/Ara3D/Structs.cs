...
namespace Ara3D
{
	...
	public partial struct DVector2 : IEquatable<DVector2>
	{
		[DataMember, HorizontalGroup("gr", LabelWidth = 20)]
		public double x;
		[DataMember, HorizontalGroup("gr", LabelWidth = 20)]
		public double y;
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public DVector2(double x, double y) { this.x = x; this.y = y; }
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public bool Equals(DVector2 x) => this.x == x.x && y == x.y;
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public DVector2 SetY(double x) => new DVector2(this.x, x);
		...
		public static implicit operator UnityEngine.Vector2(DVector2 v)
		{
			return new UnityEngine.Vector2((float)v.x, (float)v.y);
		}

		public static implicit operator DVector2(UnityEngine.Vector2 v)
		{
	...
	[DataContract]
	[Serializable]
	public partial struct DVector3 : IEquatable<DVector3>
	{
		[DataMember, HorizontalGroup("gr", LabelWidth = 20)]
		public double x;
		[DataMember, HorizontalGroup("gr", LabelWidth = 20)]
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public bool Equals(DVector3 x) => this.x == x.x && y == x.y && z == x.z;
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public DVector3 SetY(double x) => new DVector3(this.x, x, z);
		[MethodImpl(MethodImplOptions.AggressiveInlining)] public DVector3 SetZ(double x) => new DVector3(this.x, y, x);
        ...
        public static implicit operator UnityEngine.Vector3(DVector3 v)
        {
			return new UnityEngine.Vector3((float)v.x, (float)v.y, (float)v.z);
        }

        public static implicit operator DVector3(UnityEngine.Vector3 v)
        {
