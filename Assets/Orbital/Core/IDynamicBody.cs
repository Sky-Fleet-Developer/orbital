...
namespace Orbital.Core
{
    public interface IDynamicBody
    {
        ...
        public DVector3 Position => ParentCelestial.Position + LocalPosition;
        public DVector3 LocalPosition => Orbit.GetPositionAtT(TimeService.WorldTime);
        public DVector3 GetPositionAtT(double t) => ParentCelestial.GetPositionAtT(t) + Orbit.GetPositionAtT(t);
